...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*CarbonAwareArgs)(nil), (*config.CarbonAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CarbonAwareArgs_To_config_CarbonAwareArgs(a.(*CarbonAwareArgs), b.(*config.CarbonAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CarbonAwareArgs)(nil), (*CarbonAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CarbonAwareArgs_To_v1_CarbonAwareArgs(a.(*config.CarbonAwareArgs), b.(*CarbonAwareArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_CarbonAwareArgs_To_config_CarbonAwareArgs(in *CarbonAwareArgs, out *config.CarbonAwareArgs, s conversion.Scope) error {
...
// Convert_v1_CarbonAwareArgs_To_config_CarbonAwareArgs is an autogenerated conversion function.
func Convert_v1_CarbonAwareArgs_To_config_CarbonAwareArgs(in *CarbonAwareArgs, out *config.CarbonAwareArgs, s conversion.Scope) error {
	return autoConvert_v1_CarbonAwareArgs_To_config_CarbonAwareArgs(in, out, s)
}

func autoConvert_config_CarbonAwareArgs_To_v1_CarbonAwareArgs(in *config.CarbonAwareArgs, out *CarbonAwareArgs, s conversion.Scope) error {
...
// Convert_config_CarbonAwareArgs_To_v1_CarbonAwareArgs is an autogenerated conversion function.
func Convert_config_CarbonAwareArgs_To_v1_CarbonAwareArgs(in *config.CarbonAwareArgs, out *CarbonAwareArgs, s conversion.Scope) error {
	return autoConvert_config_CarbonAwareArgs_To_v1_CarbonAwareArgs(in, out, s)
}
